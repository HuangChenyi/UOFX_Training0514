...
@Component({
  ...
  templateUrl: './demo2-field.component.html',
  styleUrls: ['./demo2-field.component.css']
})
export class Demo2FieldComponent extends BpmFwWriteComponent implements OnInit {
