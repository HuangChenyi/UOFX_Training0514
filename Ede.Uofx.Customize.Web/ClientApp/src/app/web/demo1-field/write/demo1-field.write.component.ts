...
@Component({
  ...
  templateUrl: './demo1-field.write.component.html',
})

/*修改*/
/*置換className*/
export class Demo1FieldWriteComponent
  ...
  implements OnInit
{
  ...
  initForm() {
    this.form = this.fb.group({
      ...
      phone: [this.value?.phone || '', [ Validators.pattern(/^09\d{8}$/)]], // Add required validation and Taiwan phone number pattern
    });
