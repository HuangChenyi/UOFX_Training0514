...
import { Demo1FieldDesignComponent } from './design/demo1-field.design.component';

import { Demo1FieldPropsComponent } from './props/demo1-field.props.component';

import { Demo1FieldWriteComponent } from './write/demo1-field.write.component';
...
const COMPONENTS = [Demo1FieldPropsComponent, Demo1FieldWriteComponent,Demo1FieldDesignComponent];
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      ...
      { path: 'design', component: Demo1FieldWriteComponent },
      { path: 'props', component: Demo1FieldPropsComponent },
      { path: 'write', component: Demo1FieldWriteComponent },
      { path: 'view', component: Demo1FieldWriteComponent },
      { path: 'print', component: Demo1FieldWriteComponent },
      //有app開發後再實作這段
      {
        path: 'app',
        loadChildren: () => import('../../mobile/demo1-field/demo1-field.module').then(m => m.Demo1AppFieldModule)
      }
    ]),
...
export class Demo1FieldModule {
  static comp = {
    props: Demo1FieldPropsComponent,
    design: Demo1FieldDesignComponent,
    write: Demo1FieldWriteComponent,
    view: Demo1FieldWriteComponent,
    print: Demo1FieldWriteComponent,
  };
}
